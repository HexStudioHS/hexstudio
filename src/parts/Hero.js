  ...
  return (
    <section className="hero">
      <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        ...
        <p className="font-light text-l text-gray-400 leading-relaxed mb-16">
          We build modern, scalable solutions with code that connects businesses to their users.
          Our design delivers seamless, impactful experiences that drive growth and engagement.
        </p>
